...
package com.example.team_watch.viewmodel
...
import com.example.team_watch.presentation.TimerState
...
class StopwatchViewModel: ViewModel() {
    ...
    init {
        // if _timerState is changing, flatMapLatest will be executed with new timerState and mapped to getTimerFlow
        _timerState
            ...
            .onEach { timeDiff ->
                _elapsedTime.update { it + timeDiff } // it = current time
            }
